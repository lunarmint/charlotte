...
- Vectorized video decryption, roughly 12x faster than a straight port of the reference implementation
...
- Built-in updater that checks GitHub for a newer release and installs it in place
